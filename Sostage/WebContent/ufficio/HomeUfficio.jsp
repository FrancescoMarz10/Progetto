	...
	<div class="container">
				...
				<div id="opDiv">
					 ...
					 <br>
					  	...
					  	<div class="op">
					    	<a href="/Sostage/ufficio/AziendeConvenzionateUfficio.jsp" class="btn1">Visualizza Aziende Convenzionate<img id="freccia" src="/Sostage/images/freccia.png"></a>
						</div> 
						 	<br>
					
					  	<div class="op">
					    	<a href="/Sostage/ufficio/VisualizzaDocumentiUfficio.jsp" class="btn1">Visualizza Documenti<img id="freccia" src="/Sostage/images/freccia.png"></a>
						</div> 
						
							<br>
						<div class="op">
					    	<a href="/Sostage/ufficio/VisualizzaElencoTirocinanti.jsp" class="btn1">Visualizza Elenco Tirocinanti<img id="freccia" src="/Sostage/images/freccia.png"></a>
						</div> 
