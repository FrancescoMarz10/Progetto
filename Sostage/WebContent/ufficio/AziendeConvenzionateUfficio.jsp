<%@ page import="bean.NotificaBean, model.NotificaModel,bean.UfficioBean, bean.UtenteBean, model.UfficioModel,bean.AziendaBean,model.AziendaModel,java.util.*" %> 
...
<body>
	...
	<div id="titleInfo">Aziende Convenzionate</div>
		...
		<%
			...
			%>
				<tr>
					<th colspan="4">Nessun Azienda</th>
				</tr>
			<%	
			}
		%>
