<%@ page import="bean.NotificaBean, model.NotificaModel,java.util.*,bean.PresidenteBean, bean.UtenteBean, model.PresidenteModel" %> 
...
<body>
	...
	<!-- NOTIFICHE -->
		...
		<%
			...
			ArrayList<NotificaBean> notifiche= modelNot.trovaNotifichePresidente();
		...
		<% 			
					for(NotificaBean notifica: notifiche){	
						if(notifica.getTipo().equals("Presidente")){
		%>		
						<div> 
						
							<p><%=notifica.getTesto() %></p>
							<a href="/Sostage/presidente/VisualizzaNotificaPresidente.jsp?ID=<%=notifica.getID()%>"><button>Visualizza Notifica</button></a>
	...
	<div class="container">
				...
				<div id="opDiv">
					 ...
					 <br>
					  	...
					  	<div class="op">
					    	<a href="/Sostage/presidente/VisualizzaDocumentiPresidente.jsp" class="btn1">Visualizza Documenti<img id="freccia" src="/Sostage/images/freccia.png"></a>
						</div> 
	...
	<footer id="footer">
		...
		<div id="foot3">
			...
			<a href="/Sostage/studente/InfoPresidente.jsp"><p><i class="fa fa-info-circle"></i> info</p></a>
