<%@ page import="java.util.*, bean.NotificaBean, model.NotificaModel, bean.AziendaBean, bean.UtenteBean, model.AziendaModel" %> 
	...
	<div class="header">
		...
		<% 			
					for(NotificaBean notifica: notifiche){	
						...
						if(notifica.getTipo().equals("AccettaP") || notifica.getTipo().equals("RifiutaP")){
		%>		
					<div>
