<%@ page import="bean.NotificaBean, model.NotificaModel,bean.AziendaBean, bean.UtenteBean,bean.StudenteBean, model.AziendaModel, java.util.*" %> 
...
<body>
	...
	Collection<StudenteBean> studenti=(Collection<StudenteBean>)model.trovaTirocinanti(nomeAzienda);
	%>
