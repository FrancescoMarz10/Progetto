...
<body>
	...
	AziendaModel modelA= new AziendaModel();
	Collection<AziendaBean> aziende=(Collection<AziendaBean>)modelA.doRetrieveAll();
	%>
	...
	<div id="titleInfo">Aziende Convenzionate</div>
		...
		<%
			...
			if(aziende!= null && aziende.size() > 0){
					...
					while(it.hasNext()){
						AziendaBean bean1= (AziendaBean) it.next();
					%>
						<tr>
							<td><%= bean1.getNome()  %></td>
							<!-- Mail -->
							<td><%= bean1.getNomeResp() %></td>
							<td><%= bean1.getSede() %></td>
						</tr>
	...
	<footer id="footer">
		...
		<div id="foot3">
			...
			<a href="/Sostage/studente/AboutUs.jsp"><p><i class="fa fa-address-book"></i> about us</p></a>
