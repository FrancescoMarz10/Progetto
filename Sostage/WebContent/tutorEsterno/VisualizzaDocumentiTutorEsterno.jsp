<%@ page import="model.NotificaModel, bean.NotificaBean,bean.TutorEsternoBean, bean.UtenteBean, model.TutorEsternoModel,bean.StudenteBean, java.util.*" %> 
...
<body>
	...
	<!-- NOTIFICHE -->
		...
		<% 			
					for(NotificaBean notifica: notifiche){	
						if(notifica.getTipo().equals("Firma")){
		%>		
						<div> 
	...
	<nav id="bar">
		<a href="/Sostage/tutorEsterno/HomeTutorEsterno.jsp"><div class="elebar"> <p>H O M E</p> </div></a>
	...
	<div class="container">
				...
				<div id="info">
					...
					<br>
					<br>
					<form id="caricaAzienda" action="CaricaDocumentoTEServlet" method="post" enctype="multipart/form-data">
	...
	<footer id="footer">
		...
		<div id="foot3">
			<a href="/Sostage/tutorEsterno/HomeTutorEsterno.jsp"><p><i class="fa fa-home"></i> home</p></a>
