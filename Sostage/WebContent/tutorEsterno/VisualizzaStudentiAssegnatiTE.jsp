<%@ page import="bean.NotificaBean, model.NotificaModel, bean.UtenteBean,bean.StudenteBean, bean.TutorEsternoBean, model.TutorEsternoModel, java.util.*" %> 
...
<body>
	...
	String tutorEsterno=tutor.getCF();
	Collection<StudenteBean> studenti=(Collection<StudenteBean>)model.trovaStudentiAssegnati(tutorEsterno);
	%>
	...
	<footer id="footer">
		...
		<div id="foot3">
			...
			<a href="/Sostage/tutorEsterno/HomeTutorEsterno.jsp"><p><i class="fa fa-info-circle"></i> info</p></a>
			<a href="/Sostage/tutorEsterno/InfoTutorEsterno.jsp"><p><i class="fa fa-address-book"></i> about us</p></a>
