<%@ page import="model.StudenteModel,bean.NotificaBean, model.NotificaModel, java.util.*,bean.TutorEsternoBean, bean.UtenteBean, model.TutorEsternoModel" %> 
...
<body>
	<div class="header">
		...
		%>		
						<a href="#"><div> 
							...
							<a href="/Sostage/azienda/VisualizzaNotificaTE.jsp?ID=<%=notifica.getID()%>"><button>Visualizza Notifica</button></a>
	...
	<div class="container">
				...
				<div id="opDiv">
					...
					%>
					 	<h2>NOTIFICA</h2>
						<form action="EliminaNotificaTEServlet" method="post">
