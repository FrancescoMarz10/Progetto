<%@ page import="bean.NotificaBean, model.NotificaModel, java.util.*,bean.TutorEsternoBean, bean.UtenteBean, model.TutorEsternoModel" %> 
...
<body>
	<div class="header">
		...
		<%
			...
			ArrayList<NotificaBean> notifiche= modelNot.trovaNotificheTE(tutor.getCF());
		...
		<% 			
					for(NotificaBean notifica: notifiche){	
						if(notifica.getTipo().equals("FirmaTE")){
		%>		
						<div> 
						
							<p><%=notifica.getTesto() %></p>
							<a href="/Sostage/tutorEsterno/VisualizzaNotificaTE.jsp?ID=<%=notifica.getID()%>"><button>Visualizza Notifica</button></a>
	...
	<nav id="bar">
		...
		<a href="/Sostage/tutorEsterno/InfoTutorEsterno.jsp"><div class="elebar"> <p>I N F O</p> </div></a>
	...
	<div class="container">
				...
				<div id="opDiv">
					 ...
					 <br>
					  	...
					  	<div class="op">
					    	<a href="/Sostage/tutorEsterno/VisualizzaDocumentiTutorEsterno.jsp" class="btn1">Visualizza Documenti<img id="freccia" src="/Sostage/images/freccia.png"></a>
						</div> 
						 	<br>
							<br>
					  	<div class="op">
					    	<a href="/Sostage/tutorEsterno/VisualizzaStudentiAssegnatiTE.jsp" class="btn1">Visualizza Studenti Assegnati<img id="freccia" src="/Sostage/images/freccia.png"></a>
						</div> 
	...
	<footer id="footer">
		...
		<div id="foot3">
			...
			<a href="/Sostage/tutorEsterno/InfoTutorEsterno.jsp"><p><i class="fa fa-info-circle"></i> info</p></a>
